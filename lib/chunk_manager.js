...
class ChunkManager {
  ...
  #rawGetChunkAt(x, y, z) {
    return this.#chunks.get(chunkCoordsToID(x, y, z));
  }
  ...
  setChunkAt(x, y, z, chunk) {
    ...
    this.#chunks.set(chunkCoordsToID(x, y, z), chunk);
  }
  ...
  getChunkActiveMesh(x, y, z) {
    ...
    return this.#chunksWithActiveMesh.has(chunkCoordsToID(x, y, z));
  }
  
  setChunkActiveMesh(x, y, z) {
    this.#validateCoords(x, y, z);
    
    return this.#chunksWithActiveMesh.add(chunkCoordsToID(x, y, z));
  }
  
  clearChunkActiveMesh(x, y, z) {
    this.#validateCoords(x, y, z);
    
    return this.#chunksWithActiveMesh.delete(chunkCoordsToID(x, y, z));
  }
