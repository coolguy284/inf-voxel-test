class GameSettings {
  ...
  get chunkRenderingOrder() {
    return this.#settings.chunkRenderingOrder;
  }
  
  get maxChunkLoadsPerFrame() {
    return this.#settings.maxChunkLoadsPerFrame;
  }
  
  get maxChunkLoadMillisPerFrame() {
    return this.#settings.maxChunkLoadMillisPerFrame;
  }
  ...
  get chunkRenderRadiusBigint() {
    return this.#settingsRuntime.chunkRenderRadiusBigint;
  }
}
