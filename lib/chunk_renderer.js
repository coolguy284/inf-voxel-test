      ...
      for (let bz = 0; bz < worldData.chunkSize; bz++) {
        for (let bx = 0; bx < worldData.chunkSize; bx++) {
          ...
          if (blockData.renderMode != BLOCK_RENDER.NONE) {
            ...
            let negXEmpty = worldData.blockData.get(this.#chunkStore.getBlockAt(x - 1n, y, z)).renderMode == BLOCK_RENDER.NONE;
            let posXEmpty = worldData.blockData.get(this.#chunkStore.getBlockAt(x + 1n, y, z)).renderMode == BLOCK_RENDER.NONE;
            let negYEmpty = worldData.blockData.get(this.#chunkStore.getBlockAt(x, y - 1n, z)).renderMode == BLOCK_RENDER.NONE;
            let posYEmpty = worldData.blockData.get(this.#chunkStore.getBlockAt(x, y + 1n, z)).renderMode == BLOCK_RENDER.NONE;
            let negZEmpty = worldData.blockData.get(this.#chunkStore.getBlockAt(x, y, z - 1n)).renderMode == BLOCK_RENDER.NONE;
            let posZEmpty = worldData.blockData.get(this.#chunkStore.getBlockAt(x, y, z + 1n)).renderMode == BLOCK_RENDER.NONE;
