      ...
      for (let bz = 0; bz < worldData.chunkSize; bz++) {
        for (let bx = 0; bx < worldData.chunkSize; bx++) {
          ...
          if (blockData.render) {
            ...
            let negXEmpty = !worldData.blockData.get(this.#chunkStore.getBlockAt(x - 1n, y, z)).render;
            let posXEmpty = !worldData.blockData.get(this.#chunkStore.getBlockAt(x + 1n, y, z)).render;
            let negYEmpty = !worldData.blockData.get(this.#chunkStore.getBlockAt(x, y - 1n, z)).render;
            let posYEmpty = !worldData.blockData.get(this.#chunkStore.getBlockAt(x, y + 1n, z)).render;
            let negZEmpty = !worldData.blockData.get(this.#chunkStore.getBlockAt(x, y, z - 1n)).render;
            let posZEmpty = !worldData.blockData.get(this.#chunkStore.getBlockAt(x, y, z + 1n)).render;
